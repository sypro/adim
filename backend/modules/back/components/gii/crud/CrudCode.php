...
class CrudCode extends CCodeModel
{
	...
	public $model;
	public $controller;
	public $baseControllerClass = '\back\components\BackController';
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			...
			array('model', 'match', 'pattern'=>'/^[\w+\\.\\\\]*$/', 'message'=>'{attribute} should only contain word characters and dots.'),
	...
	public function getBaseControllerClassNamespace()
	{
		return trim($this->baseControllerClass, '\\');
	}

	public function getBaseControllerClassWithoutNamespace()
	{
		$array = $array = explode('\\', $this->baseControllerClass);
		return end($array);
	}
}
