...
class BackstageController extends Controller
{
	 ...
	 * @var string
	 */
	public $layout = 'backstage.views.layouts.column1';
	...
	{
		$this->render('backstage.components.adminTemplates.view', array(
	...
	public function actionCreate()
	{
		...
		$this->render('backstage.components.adminTemplates.create', array(
			'model' => $model,
			'form' => $form,
		));
	}
	...
	public function actionIndex()
	{
		...
		$this->render('backstage.components.adminTemplates.index', array(
			'model' => $model,
		));
	}
	...
	public function actionDependent()
	{
		...
		if ($class === 'backstage\components\DependentDropDownFormInputElement') {
			...
			throw new \CHttpException(400, t('Field type must be "dropdownlist" or "backstage\components\DependentDropDownFormInputElement"'));
		}
