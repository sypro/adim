...
<?php /** @var $form CCodeForm */ $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'fixUnsignedInt'); ?>
		<?php echo $form->checkBox($model,'fixUnsignedInt'); ?>
		<div class="tooltip">
			By default Yii describe unsigned int fields as a string.
			This feature will describe they as integer
		</div>
		<?php echo $form->error($model,'fixUnsignedInt'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'preparePropertyColumns'); ?>
		<?php echo $form->checkBox($model,'preparePropertyColumns'); ?>
		<div class="tooltip">
			Prevent adding already described fields in phpDoc
		</div>
		<?php echo $form->error($model,'preparePropertyColumns'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'prepareSearchColumns'); ?>
		<?php echo $form->checkBox($model,'prepareSearchColumns'); ?>
		<div class="tooltip">
			Prevent adding necessary fields in search
		</div>
		<?php echo $form->error($model,'prepareSearchColumns'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'prepareRules'); ?>
		<?php echo $form->checkBox($model,'prepareRules'); ?>
		<div class="tooltip">
			Prevent adding unnecessary fields in rules
		</div>
		<?php echo $form->error($model,'prepareRules'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'multiLang'); ?>
		<?php echo $form->checkBox($model,'multiLang'); ?>
		<div class="tooltip">
			Add multi language behavior and methods
		</div>
		<?php echo $form->error($model,'multiLang'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'langModel'); ?>
		<?php echo $form->checkBox($model,'langModel'); ?>
		<div class="tooltip">
			Remove unnecessary methods for language model (ModelLang)
		</div>
		<?php echo $form->error($model,'langModel'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'seoModel'); ?>
		<?php echo $form->checkBox($model,'seoModel'); ?>
		<div class="tooltip">
			Add SEO behavior
		</div>
		<?php echo $form->error($model,'seoModel'); ?>
	</div>
	<div class="row">
