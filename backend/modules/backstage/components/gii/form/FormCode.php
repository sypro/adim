...
class FormCode extends CCodeModel
{
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			...
			array('model, viewPath', 'match', 'pattern'=>'/^[\.\w+\\\\]*$/', 'message'=>'{attribute} should only contain word characters and dots.'),
...
EOD;
	...
	public function validateModel($attribute,$params)
	{
		...
		if(!is_string($class) || !$this->classExists(trim($class, "\\")))
	...
	public function prepare()
	{
		...
		$this->files[]=new CCodeFile(
			...
			$this->render($templatePath.'/form.php', $params)
		);
	}
	...
	public function getColumns()
	{
		...
		$table = $connection->getSchema()->getTable($model->tableName(), $connection->schemaCachingDuration!==0);
