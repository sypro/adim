...
/**
 * Class m140928_144614_create_principles_table_lang
 */
class m140928_144614_create_principles_table_lang extends \CDbMigration
{
	/**
	 * migration related table name
	 */
	public $tableName = '{{principles_lang}}';

	/**
	 * main table name, to make constraints
	 */
	public $relatedTableName = '{{principles}}';
