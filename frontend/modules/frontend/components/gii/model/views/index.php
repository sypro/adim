...
<?php /** @var $form CCodeForm */ $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'rulesAndLabels'); ?>
		<?php echo $form->checkBox($model,'rulesAndLabels'); ?>
		<div class="tooltip">
			Add rules and attribute labels, if this model used in form
		</div>
		<?php echo $form->error($model,'rulesAndLabels'); ?>
	</div>
<?php $this->endWidget(); ?>
