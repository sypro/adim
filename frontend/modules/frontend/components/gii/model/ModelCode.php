 ...
 *
 */
use frontend\helpers\GiiHelper;
...
class ModelCode extends \CCodeModel
{
	...
	public $baseClass='\frontend\components\ActiveRecord';
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			...
			//array('baseClass', 'match', 'pattern'=>'/^[a-zA-Z_\\\\]\w*$/', 'message'=>'{attribute} should only contain word characters and \\'),
			array('modelPath', 'validateModelPath', 'skipOnError'=>true),
			array('baseClass, modelClass', 'validateReservedWord', 'skipOnError'=>true),
			array('baseClass', 'validateBaseClass', 'skipOnError'=>true),
			array('connectionId, tablePrefix, modelPath, baseClass, buildRelations, fixUnsignedInt, preparePropertyColumns, multiLang, langModel, seoModel, rulesAndLabels', 'sticky'),
		));
	}
	...
	public function attributeLabels()
	{
		return array_merge(parent::attributeLabels(), array(
			...
			'seoModel' => 'SEO model',
			'rulesAndLabels' => 'Add rules and attribute labels',
		));
	}
	...
	public function generateLabels($table)
	{
		$labels=array();
		$default = array();
		//array_keys(GiiHelper::getDefaultLabels());
		foreach($table->columns as $column)
		{
			if(in_array($column->name, $default, true))
			{
	...
	{
		return strtr($this->modelPath, array('.' => '\\', 'application' => self::BASE_NAMESPACE, ));
	}
}
